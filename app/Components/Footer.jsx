...
export default function Footer() {
  return (
    <footer className="lg:absolute bottom-0 h-max lg:h-44 w-full flex items-center justify-center lg:gap-0 gap-5 flex-col py-10 lg:py-0 bg-mainDark text-whiteColor">
