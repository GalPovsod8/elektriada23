...
export default function Footer() {
  return (
    <footer className="lg:absolute font-Montserrat bottom-0 h-max lg:h-max w-full flex items-center justify-center lg:gap-0 gap-5 flex-col py-10 lg:py-0 animate-show bg-mainDark text-whiteColor">
        <div className="h-full w-4/5 lg:w-3/5 flex items-center justify-between flex-col lg:flex-row text-xl font-normal lg:gap-4 gap-10">
            ...
            <div className="lg:h-52 lg:w-1 h-px w-full bg-whiteColor"></div>
            <div className="grid place-items-center w-full">
                <Link className="flex items-center justify-center group h-full" href="https://www.srednjasolaravne.si/" target="blank">
                    <img className="h-4/5 w-auto group-hover:scale-105 transition-all ease-in-out duration-200" src={ssrLogo} alt="Srednja Šola Ravne" height={1000} width={1000}/>
                </Link>
            </div>
            <div className="lg:h-52 lg:w-1 h-px w-full bg-whiteColor"></div>
